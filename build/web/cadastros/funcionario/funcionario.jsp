            ...
            <tbody>
                <c:forEach var="funcionario" items="${funcionarios}">
                    <tr>
                        ...
                        <td align="center">
                            <a href="${pageContext.request.contextPath}/FuncionarioExcluir?idFuncionario=${funcionario.idFuncionario}">Excluir</a></td>
                        <td align="center">
                            <a href="${pageContext.request.contextPath}/FuncionarioCarregar?idFuncionario=${funcionario.idFuncionario}">Alterar</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
