            ...
            <tbody>
                <c:forEach var="tipoProduto" items="${tipoProdutos}">
                    <tr>
                        ...
                        <td align="center">
                            <a href="${pageContext.request.contextPath}/TipoProdutoExcluir?idTipoProduto=${tipoProduto.idTipoProduto}">Excluir</a></td>
                        <td align="center">
                            <a href="${pageContext.request.contextPath}/TipoProdutoCarregar?idTipoProduto=${tipoProduto.idTipoProduto}">Alterar</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
