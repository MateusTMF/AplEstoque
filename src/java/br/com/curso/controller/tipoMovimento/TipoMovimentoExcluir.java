    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (dao.excluir(idTipoMovimento)){
                mensagem = "Tipo de Movimento Excluido com Sucesso!";
            }else {
                mensagem = "Problemas ao Excluir Tipo de Movimento.";
            }
            request.setAttribute("mensagem", mensagem);
            response.sendRedirect("TipoMovimentoListar");
        }catch (Exception ex){
            System.out.println("Problemas no Servlet ao excluir Tipo de Movimento! Erro: "+ex.getMessage());
        }
    }
