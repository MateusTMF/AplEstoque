    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        oTipoMovimento.setDescricao(descricao);
            ...
            if (dao.cadastrar(oTipoMovimento)){
                mensagem = "Tipo de Movimento Cadastrado com Sucesso!";
            }else {
                mensagem = "Problemas ao Cadastrar o Tipo de Movimento. Verifique os dados informados e tente novamente!";
            }
            request.setAttribute("mensagem", mensagem);
            response.sendRedirect("TipoMovimentoListar");
        }catch (Exception ex){
            System.out.println("Problemas no Servlet ao cadastrar o Tipo de Movimento! Erro: "+ex.getMessage());
        }
    }
